...
/*   Updated: 2022/12/31 20:56:01 by dfurneau         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
# define SGFX "./assets/gun"
# define FRM 7
# define LIGHT_EFFECT 4
# define EN_LIGHT_EFFECT 1
# define DOOR_DISTANCE 5.25
# define DOOR_AUTO_OPEN 0
...
/**
 * Door Structure
 * loc = 2d array of t_vector holding door locations
 * open = state of doors
 ...
 * 	[1] = Ceiling
 * **map = 2d map data
 * map_row = Number of rows (y) in the map
 * map_col = Number of columns (x) in the map
 * *door = Door Structure to hold location and state of door
 * light_eff = Lighting effect toggle
 **/
...
void		alloc_detect(t_gamedata *gd);
void		free_detect(t_gamedata *gd);
void		init_detect(t_plyrdata *pd);
void		print_detect(t_gamedata *gd);
